...
// export default function TestExerciseButton() {
...
//   // Use THIS instead of the old formData-based storeWorkout
...
//     setSaving(true);
//     try {
//       // normalize fields coming back from the model
...
//       const toNumber = (v) => {
//         // model might send "60" or "60 minutes" or number
...
//         isCompleted: false,
//         // optional: when you want it scheduled/dated
...
//           <button onClick={storeWorkoutFromResult} disabled={saving}>
...
export default function TestExerciseButton() {
  ...
  async function handleClick() {
    ...
    try {
      const res = await fetch('/api/workout', {  // your model endpoint
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          goal: 'build upper body strength',
